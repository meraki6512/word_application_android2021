...
public class AlarmAdapterActivity extends BaseAdapter {

    public ArrayList<TimeItem> listviewitem = new ArrayList<TimeItem>();
    private ArrayList<TimeItem> arrayList = listviewitem;   //백업 arrayList
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        TimeItem time = arrayList.get(position);
    ...
    public void addItem(int hour, int minute, String am_pm, int month, int day) {
